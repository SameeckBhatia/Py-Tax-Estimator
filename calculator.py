...
def australia(b, owed, perc, net):
    ...
    if income >= 0:
        ...
        owed.config(text = "A$" + str(round(tax, 1)))
        net.config(text = "A$" + str(round(income - tax, 1)))
        perc.config(text = str(round(percent, 1)) + "%")
...
def canada(b, owed, perc, net):
    ...
    if income >= -sd:
        ...
        #output values to user
        owed.config(text = "C$" + str(round(tax, 1)))
        net.config(text = "C$" + str(round(income - tax, 1)))
        perc.config(text = str(round(percent, 1)) + "%")
...
def uk(b, owed, perc, net):
    ...
    if income >= 0:
        ...
        #output values to user
        owed.config(text = "£" + str(round(tax, 1)))
        net.config(text = "£" + str(round(income - tax, 1)))
        perc.config(text = str(round(percent, 1)) + "%")
