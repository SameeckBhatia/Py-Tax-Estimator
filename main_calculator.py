...
from australia_code import australia; from canada_code import canada;
from uk_code import uk; from usa_code import states
...
#Buttons and labels
Button(win, text = "Calculate", font = "Bahnschrift 11", width = "15", command = tax).place(x = "50", y = "255")
Button(win, text = "End program", font = "Bahnschrift 11", width = "15", command = win.quit).place(x = "300", y = "255")
